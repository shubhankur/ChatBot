...
id_model.load_state_dict(torch.load(id_model_path,map_location=torch.device('cpu')), strict=False)
ego_model.load_state_dict(torch.load(ego_model_path,map_location=torch.device('cpu')), strict=False)
superego_model.load_state_dict(torch.load(superego_model_path,map_location=torch.device('cpu')), strict=False)
